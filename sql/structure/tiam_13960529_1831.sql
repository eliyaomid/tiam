...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 20, 2017 at 05:01 PM
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Stores block settings, such as region and visibility...' AUTO_INCREMENT=33 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='List of English source strings.' AUTO_INCREMENT=4871 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Contains the individual links within a menu.' AUTO_INCREMENT=318 ;
...
CREATE TABLE IF NOT EXISTS `queue` (
  ...
  KEY `expire` (`expire`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Stores items in queues.' AUTO_INCREMENT=31 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Table that contains logs of all system events.' AUTO_INCREMENT=53 ;
